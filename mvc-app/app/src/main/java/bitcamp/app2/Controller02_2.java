...
public class Controller02_2 {
  ...
  // 테스트
  // http://localhost:8888/app2/c02_2?name=aaa&age=20
  @GetMapping
  @ResponseBody
  ...
  // 테스트
  // http://localhost:8888/app2/c02_2/okok;name=aaa;age=30
  ...
  // 테스트
  // http://localhost:8888/app2/c02_2/name=aaa;qty=6/title=okok;state=1
  ...
  // 테스트
  // http://localhost:8888/app2/c02_2/h4/name=team1;qty=6/name=task1;qty=3

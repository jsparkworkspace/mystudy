...
public class DispatcherServlet extends HttpServlet {
  ...
  private Object[] prepareRequestHandlerArguments(
      Method handler, HttpServletRequest request, HttpServletResponse response) throws Exception {
  ...
  private Object createValueObject(Class<?> type, HttpServletRequest request) throws Exception {
    ...
    for (Method setter : methods) {
      ...
      if (requestParamValue != null) {
        ...
        // 예) setFirstName("길동");
        setter.invoke(obj,
            valueOf(requestParamValue, setterParameterType));
      }
    }
    return obj;
  }
